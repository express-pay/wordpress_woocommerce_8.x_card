...
final class WC_Gateway_ExpressPay_Card_Blocks_Support extends AbstractPaymentMethodType {
	...
	public function get_payment_method_script_handles() {
		...
		if ( function_exists( 'wp_set_script_translations' ) ) {
			wp_set_script_translations( 'wc-expresspay-card-payments-blocks', 'woocommerce-gateway-expresspay-card', WC_ExpressPay_Card_Payments::plugin_abspath() . 'languages/' );
		}
